...
unsigned char pageSelection;
volatile unsigned char * hiresPage1 = (volatile unsigned char *)0xC054;
volatile unsigned char * hiresPage2 = (volatile unsigned char *)0xC055;
#endif
